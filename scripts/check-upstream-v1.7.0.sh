...
upstream_tag="v1.7.0"
expected_commit="c3688ba88edff12dfcb1ced007e332711509ac29"
...
while IFS='|' read -r package_directory package_name; do
  ...
  if [[ "${actual_name}" != "${package_name}" || "${actual_version}" != "1.7.0" ]]; then
...
echo "Verified 35 social providers, 25 built-in plugin exports, and 7 plugin packages."
