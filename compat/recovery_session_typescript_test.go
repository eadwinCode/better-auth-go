...
func TestBetterAuthV1626PasswordRecoveryCompatibility(t *testing.T) {
...
func TestBetterAuthV1626EmailVerificationCompatibility(t *testing.T) {
	oracle := newTypeScriptOracle(t)
	oracle.clearMail(t)
...
func TestBetterAuthV1626SessionManagementCompatibility(t *testing.T) {
	oracle := newTypeScriptOracle(t)
